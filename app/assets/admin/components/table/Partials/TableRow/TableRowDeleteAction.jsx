        ...
        <>
          ...
          <ModalBody>
            <div className="flex justify-between">
              <AppButton variant="primary" additionalClasses="px-4 py-2.5 font-bold" onClick={() => confirmClick()}>Tak</AppButton>
              <AppButton variant="secondary" additionalClasses="px-4 py-2.5 font-bold" onClick={closeModal} >Nie</AppButton>
            </div>
          </ModalBody>
        </>
      )
