...
const ProductPricing: React.FC<ProductPricingProps> = ({ register, fieldErrors, watch, formContext, control }) => {
    ...
    return (
        <FormSection title="Cena">
            <FormGroup label={<InputLabel isRequired={true} label="Cena podstawowa" htmlFor="regularPrice" />}>
                <InputField
                    type="text"
                    id="regularPrice"
            ...
            {watch().promotionIsActive && (
                <>
                    <FormGroup label={<InputLabel isRequired={true} label="Zakres promocji" />}>
                        <Controller
                    ...
                    <FormGroup label={<InputLabel isRequired={true} label="Typ promocji" />}>
                    ...
                    <FormGroup label={<InputLabel isRequired={true} label="Obniżka" />}>
                        <InputField
                            type="number"
