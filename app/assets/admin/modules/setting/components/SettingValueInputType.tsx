...
const SettingValueInputType: React.FC<SettingInputTypeProps> = ({ register, control, formData }) => {
    ...
    switch (settingField?.inputType) {
        case SettingInputType.SELECT:
            return <SettingValueInputTypeSelect control={control} settingField={settingField} isMulti={false} />;
        case SettingInputType.MULTISELECT:
            return <SettingValueInputTypeSelect control={control} settingField={settingField} isMulti={true} />;
        case SettingInputType.CHECKBOX:
            return <SettingValueInputTypeCheckbox register={register} />;
        case SettingInputType.RAW_TEXTAREA:
            return <SettingValueInputTypeRawTextarea register={register} />;
