...
const SettingForm = () => {
    ...
    useEffect(() => {
        ...
        const formFieldNames = ['name', 'isActive', 'settingField'] satisfies (keyof SettingFormData)[];
    ...
    return (
        ...
        >
            <FormApiLayout pageTitle="Edytuj ustawienie">
                <SettingFormBody register={register} control={control} fieldErrors={fieldErrors} formData={formData} />
            </FormApiLayout>
        </FormWrapper>
    );
};
