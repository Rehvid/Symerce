...
const DashboardBestsellers: FC<DashboardBestsellersProps> = ({ bestsellers }) => {
    return (
        <>
            <Heading additionalClassNames="mb-[1.75rem]" level={HeadingLevel.H3}>
                            ...
                            <tr className="odd:bg-gray-50 mb-3" key={key}>
                                ...
                                <td className="py-2 px-4 text-sm whitespace-nowrap">
                                    {bestseller.isInStock ? (
                                        ...
                                        <span className="inline-flex items-center px-2.5 py-1 text-sm font-medium rounded-full bg-red-100 text-red-800">
                                            Brak
                                        </span>
                                    )}
                                </td>
